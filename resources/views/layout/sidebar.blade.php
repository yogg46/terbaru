<div id="kt_aside" class="aside {{ auth()->user()->hitam == '1' ? 'aside-dark': 'aside-light'}} aside-hoverable"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="/">
            <img alt="Logo"
                src="/assets/media/logos/{{ auth()->user()->hitam == '1' ? 'logo-1-dark.svg': 'logo-1.svg'}} "
                class="h-25px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $tittle == 'Bug Report' ? 'active':''}}" href="/bug-report">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ $tittle == 'Trial Error' ? 'active':''}}" href="/trial-error">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
