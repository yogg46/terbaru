                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                        ...
                        <div class="menu-item me-lg-1">
                            <a class="menu-link {{ $tittle == 'Dashboard' ?  'active' : ''}} py-3" href="/home">
                        ...
                        {{-- <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                            ...
                            <div
                                class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="../../demo1/dist/documentation/base/utilities.html"
                                ...
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="../../demo1/dist/documentation/getting-started.html"
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <span class="symbol-label bg-warning  text-inverse-warning fw-bolder">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <span
                                            class="badge badge-light-success fw-bolder align-items-start fs-8 mx-auto">{{
                                            Auth::user()->utk->kategori }}</span>
                                        {{-- <a href="#"
                            ...
                            <div class="menu-item px-5">
                                <a href="{{route('profil.index')}}"
                                    class="menu-link {{ $tittle == 'Profil' ? 'active' : ''}} px-5">My Profile</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
