...
<html lang="en">
	...
	<head><base href="../../">
        ...
        @endif
        @else
        <link href="assets/plugins/global/{{auth()->user()->hitam == '1' ? 'plugins.dark.bundle.css' :'plugins.bundle.css'}} " rel="stylesheet" type="text/css" />
		<link href="assets/css/{{auth()->user()->hitam == '1' ? 'style.dark.bundle.css' :'style.bundle.css'}}" rel="stylesheet" type="text/css" />
        @endguest --}}
				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
                    ...
                    @guest
						...
						<div class="text-center">
							<a href="{{ route('login') }}" class="btn btn-outline  btn-outline-primary fw-bolder">Login</a>
						</div>
                        </form>
                        @endif
                        @else
                        <form action="{{ route('home') }}" class="form-inline" role="form">
                            <div class="text-center">
                                <a href="{{ route('home') }}" class="btn btn-outline btn-outline-primary fw-bolder">Go to homepage</a>
                            </div>
                        </form>
