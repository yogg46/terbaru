                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap ">
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    @if ((in_array(Auth::user()->id, $buger) || $project->leader == Auth::user()->id) && $project->status == 6)
                                        <div class="me-0">
                                            <a data-bs-toggle="modal" data-bs-target="#modal_releas"
                                                class="btn btn-sm  btn-light-success text-hover-white  btn-active-color-success">
                                                <span class="text-active-white text-hover-white">
                                        ...
                                        <div wire:ignore.self class="modal fade" tabindex="-1" id="modal_releas">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Release Bug</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Apakah Anda yakin akan Merilis Bug Baru
                                                            {{ $project->nama_project }}
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-light"
                                                            data-bs-dismiss="modal">Close</button>
                                                        <button type="button"
                                                            wire:click="release2({{ $project->id }}) "
                                                            class="btn btn-primary">Save changes</button>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="col-xxl-8">
                ...
                <div class="card card-xxl-stretch mb-5 mb-xl-10">
                    ...
                    <div class="card-header ">
                        ...
                        @if (Auth::user()->id == $project->leader && $swit == 0 && $project->status != 5 && $project->status != 6)
                        ...
                        @endif
                        @if (Auth::user()->id == $project->leader && $swit == 1 && $project->status == 5)
                            <div wire:ignore.self class="card-toolbar" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-trigger="hover" title=""
                                data-bs-original-title="Click to add a Modul">
                                <a href="#" class="btn btn-sm btn-light-info btn-active-primary"
                                    data-bs-toggle="modal" data-bs-target="#modal_revisi">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
...
<div wire:ignore.self class="modal fade" id="modal_revisi" tabindex="-1" style="display: none;"
    data-select2-id="select2-data-kt_modal_new_target" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px" data-select2-id="select2-data-72-0keh">
        <!--begin::Modal content-->
        <div class="modal-content rounded" data-select2-id="select2-data-71-5p7c">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Report a release bug</h1>
                        <!--end::Title-->
                        <!--begin::Description-->
                        <!--end::Description-->
                    </div>
                    ...
                    <div
                        ...
                        <!--begin::Label-->
                        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                            <span class="required">Nama Release Bug</span>
                            <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip"
                                title=""
                                data-bs-original-title="Specify a target name for future usage and reference"
                                aria-label="Specify a target name for future usage and reference"></i>
