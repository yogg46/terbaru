        ...
        <a href="/karyawan" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center ">
                    ...
                    <div class="text-white fs-1 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{$tot}}"
        ...
        <a href="/karyawan" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center ">
                    ...
                    <div class="text-white fs-1 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{$act}}"
                        data-kt-countup-prefix="">0</div>
                </div>
                <!--end::Svg Icon-->
        ...
        <a href="/karyawan" class="card card-flush bg-danger hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body ">
                ...
                <div class="d-flex align-items-center ">
                    ...
                    <div class="text-white fs-1 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{$sus}}"
                        data-kt-countup-prefix="">0</div>
                </div>
                <!--end::Svg Icon-->
    ...
    <div class="col-xl-4">
        ...
        <div class="card card-xl-stretch mb-xl-8">
            ...
            <div class="card-body   p-0 d-flex flex-column">
                <!--begin::Stats-->
                <div class="card-p pt-5bg-body ">
                    <div class="hover-scroll h-450px px-2">
                        <div class="timeline-label">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-badge">
                                    <i
                                        class="fa fa-genderless {{ $item->deskripsi == 'has log out' ? 'text-danger' : 'text-success'}} fs-1"></i>
                                </div>
                                <!--end::Badge-->
                                <!--begin::Content-->
