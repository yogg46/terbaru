            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center ">
                    ...
                    <div class="text-white fs-1 fw-bolder" data-kt-countup="true"
                        data-kt-countup-value="{{ $tot }}" data-kt-countup-prefix="">0</div>
                </div>
                <!--end::Svg Icon-->
        ...
        <a href="/karyawan" class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center ">
                    ...
                    <div class="text-white fs-1 fw-bolder" data-kt-countup="true"
                        data-kt-countup-value="{{ $act }}" data-kt-countup-prefix="">0</div>
                </div>
                <!--end::Svg Icon-->
        ...
        <a href="/karyawan" class="card card-flush bg-danger hoverable card-xl-stretch mb-xl-8">
            ...
            <div class="card-body ">
                ...
                <div class="d-flex align-items-center ">
                    ...
                    <div class="text-white fs-1 fw-bolder" data-kt-countup="true"
                        data-kt-countup-value="{{ $sus }}" data-kt-countup-prefix="">0</div>
                </div>
                <!--end::Svg Icon-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content d-flex">
                                        <span
                                            ...
                                            <span class="text-muted ps-0"> {{ $item->date_time }}</span>
