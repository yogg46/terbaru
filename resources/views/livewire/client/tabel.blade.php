<div class="d-flex flex-wrap flex-stack pb-7">
    ...
    <div class="d-flex flex-wrap align-items-center my-1">
        ...
        <select wire:model="search" class="form-select mx-3 w-150px ps-9 form-select-sm form-select-white">
        ...
        @if ($ceklis)
            <div class=" d-flex justify-content-end align-items-center">
                <div class="fw-bolder me-5 me-2">{{ count($ceklis) }} Selected</div><button type="button"
                    data-bs-toggle="modal" data-bs-target="#kt_modal_46" class="btn btn-sm btn-danger"> Delete
                    Selected</button>
            </div>
        @else
            <!--begin::Tab nav-->
            ...
            <div class="row g-6 g-xl-9">
                ...
                @foreach ($client2 as $item)
                    <div class="col-md-6 col-xl-4">
                        <!--begin::Card-->
                        <div
                            class="card border bg-hover-lighten
                        ...
                        {{ $item->no_kc == 3 ? ' bg-hover-light-primary ' : '' }}
                         border-2 border-gray-300 border-hover">
                            ...
                            <div class="card-body p-9">
                                ...
                                <p class="text-gray-400 fw-bold fs-5 mt-1 mb-7"><strong
                                        class="text-gray-500 ">{{ $item->cp }}
                            ...
                            <thead class="fs-7 text-gray-400 text-uppercase">
                                <tr>
                                    ...
                                    <th wire:click="sortBy('client_id')" style="cursor: pointer;"
                                        class="min-w-100px">No
                                        Client
                                        @include('layout.sort-icon', ['field' => 'client_id'])</span></th>
                                    <th wire:click="sortBy('nama')" style="cursor: pointer;" class="min-w-100px">
                                        <span>Nama
                                    ...
                                    <th wire:click="sortBy('no_kc')" style="cursor: pointer;" class="min-w-90px ">
                                        Kategori
                                        ...
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox"
                                                    value="{{ $item->id }}" wire:model="ceklis" />
                                            </div>
                                        </td>
                                     ...
                                     fw-bolder px-4 py-3">{{ $item->r_kc->nama }}</span>
                                        ...
                                        <td class="text-end">
                                            <div class=" btn-group">
                                                ...
                                                <button wire:click.prevent="confrimDel1({{ $item->id }})"
