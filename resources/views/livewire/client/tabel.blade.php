...
<div class="d-flex flex-wrap flex-stack pb-7">
    ...
    <div class="d-flex flex-wrap align-items-center my-1">
        ...
        <button class="fw-bolder btn btn-light-success btn-sm me-5 my-1"> <i class="las fs-3 la-plus "></i>Add Client</button>
<div class="d-flex align-items-center position-relative my-1">
    ...
    <!--end::Svg Icon-->
    <input type="text" wire:model="search"  class="form-control form-control-white form-control-sm w-150px ps-9" placeholder="Search" />
    ...
    <div class="d-flex flex-wrap my-1">
        @if ($ceklis)
                ...
                <div class="fw-bolder me-5 me-2">{{count($ceklis)}} Selected</div><button type="button"  wire:click="deleteCountries" class="btn btn-sm btn-danger"> Delete Selected</button>
                </div>
                @else
                ...
                <div class="col-md-6 col-xl-4">
                    ...
                    <div href="" class="card border bg-hover-lighten
                            ...
                            <div class="card-toolbar">
                                ...
                                <div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <button  wire:click.prevent='destroy({{$item->id}})' class="btn bg-hover-light-danger text-hover-danger  menu-link px-3"> Delete </button>
                                        </div>
                                        <div class="menu-item px-3">
                                            <button  wire:click.prevent='destroy({{$item->id}})' class="btn bg-hover-light-danger text-hover-danger  menu-link px-3"> Delete </button>
                                        </div>
                        ...
                        <div class="card-body p-9">
                            ...
                            <p class="text-gray-400 fw-bold fs-5 mt-1 mb-7"><strong class="text-gray-500 ">{{ $item->cp}} </strong> <br> {{ $item->alamat}} </p>
                            <!--end::Description-->
                            <!--begin::Info-->
                            ...
                            {{-- <div class="symbol-group symbol-hover">
                                ...
                                <div class="symbol symbol-35px symbol-badge" data-bs-toggle="tooltip" title="{{ $c->nama_project  }}">
                                    <span class="symbol-label bg-primary text-inverse-primary fw-bolder">{{mb_substr($c->nama_project, 0, 1, "UTF-8")}}</span>
                                </div>
                    ...
                    <table id="kt_project_users_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bolder">
                        ...
                        <thead class="fs-7 text-gray-400 text-uppercase">
                            <tr>
                                ...
                                <th wire:click="sortBy('client_id')" style="cursor: pointer;" class="min-w-100px">No Client
                                ...
                                <th wire:click="sortBy('no_kc')" style="cursor: pointer;" class="min-w-90px ">Kategori @include('layout.sort-icon',['field'=>'no_kc'])</th>
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class=" btn-group" >
                                    <button wire:click.prevent="edit({{$item->id}})" data-toggle="modal" data-target="#editmodal" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    ...
                                    <button wire:click.prevent="destroy({{$item->id}})"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
