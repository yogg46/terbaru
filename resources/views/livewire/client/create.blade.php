    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <!--end::Modal title-->
                <!--begin::Close-->
                <div class="btn btn-sm btn-icon btn-active-color-primary" wire:click="resetInput()"
            ...
            <div class="modal-body py-lg-10 px-lg-10">
                ...
                <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid"
                    ...
                    <div class="flex-row-fluid py-lg-5 px-lg-15">
                        <!--begin::Form-->
                        <form wire:submit.prevent="save" class="form" novalidate="novalidate"
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                                            <span class="required">Nama Client {{ $no_kc }} {{ $nama }}</span>
                                        ...
                                        <div class="fv-row">
                                            ...
                                            <label class="d-flex flex-stack mb-5 cursor-pointer">
                                                ...
                                                <span class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" type="radio" wire:model='no_kc'
                                            ...
                                            <label class="d-flex flex-stack mb-5 cursor-pointer">
                                                ...
                                                <!--begin:Input-->
                                                <span class="form-check form-check-custom form-check-solid">
                                                    <input class="form-check-input" wire:model='no_kc' type="radio"
