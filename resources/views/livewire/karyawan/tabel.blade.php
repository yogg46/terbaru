            ...
            <tbody wire:loading.class="opacity-90" class="text-gray-600 fw-bold">
                ...
                @forelse ($karyawan as $item)
                    <tr>
                        ...
                        <!--begin::Billing=-->
                        <td><span
                                class="badge  text-hover-inverse-light
                            ...
                            {{ $item->utk->kategori == 'Administator' ? 'badge-light-success' : '' }} mb-1">{{ $item->utk->kategori }}</span>
                        </td>
                        ...
                        <td class="text-center">
                            @if ($item->status == 1)
                                <button data-kt-customer-table-select="delete_selected"
