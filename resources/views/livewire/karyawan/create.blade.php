<div>
    <div>
        ...
        <div wire:ignore.self class="modal modal-primary fade" id="kt_modal_2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="form-group">
                        ...
                        <select wire:ignore.self wire:model='role' class="form-select form-select-solid"  data-hide-search="true" data-placeholder="Pilih Jabatan" >
                            {{-- <option ></option> --}}
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn  btn-light-danger"  data-bs-dismiss="modal" wire:click.prevent="resetInput()"">Close</button>
